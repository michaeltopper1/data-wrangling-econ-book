...
* (Exercise 1.2.1) The most common review rating is `r top_review_ratings[1]` if we take into consideration missing values, and `r top_review_ratings[2]` if we do not take missing values into consideration. 
 ...
 * (Exercise 1.5.1) Of the movies that were released in USA or had a rating of "NOT RATED" the highest review rating was a 9.8 by the movie `r only_usa$title[1]`.
 ...
 * (Exercise 1.5.2) Of the movies that were released in USA or Japan, there were `r only_usa_japan$n` movies that were rated "PG-13". 